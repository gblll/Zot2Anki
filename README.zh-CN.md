...
**v0.2.0-rc.3：Windows 预发布候选版。** 将一篇 Zotero 生词 Note 同步到 Anki，并保留卡片身份、个人 Notes 和复习历史。仓库已公开；本候选版准备为 Draft Pre-release，不是稳定版。
...
GitHub Support 于 2026-09-07 确认清理未引用提交；2026-09-08 在已登录浏览器中核验，两个已知受影响的旧提交页面均显示 404。核验范围限于这两个页面，不代表检查了所有历史缓存。仓库已公开，rc.2 已于 2026-09-08 公开预发布。rc.3 增加期刊显示改进，发行附件按准确提交构建和验收；rc.1 草稿、rc.2 发行及其标签和附件保留不变。本轮仅使用合成数据，历史真实资料检查不视为 rc.3 验收。
